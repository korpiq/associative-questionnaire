...
description: Execute repository work directly from TODO tracking. Use when the user asks to work through TODO items, complete tasks in dependency order, verify each finished step, move it from TODO to docs/done.md, and commit each verified step before starting the next one.
---
...
6. Commit that verified step before starting the next TODO item.
...
- When working through several TODO items alone, do not batch them into one commit.
