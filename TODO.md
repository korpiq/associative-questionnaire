...
0. Make an example showing how to override each of our HTML snippets.

1. Rework Gherkin scenarios to avoid repeated step text where the parser rejects repetition.
